...
public class Level {
	...
	public Level(int level) {
		...
		case 000:	//TUTORIAL LEVEL ??
			...
			pickups.add(new Pickup(14, 8, "wallJump"));
			pickups.add(new Pickup(14, 8, "dash"));
			pickups.add(new Pickup(14, 8, "doubleJump"));
			levelW = 3904;
			levelH = 3328;
			miniYOffset = 640;
			miniXOffset = 0;
		...
		case 200: //Crash Zone Ship Entrance
			...
			platforms.add(new Platform(-16, 3, 77, 2, 1));
...
//			//challenge
		...
		case 300: //Waterfall Crash Zone Entrance
			...
			actors.add(new GroundEnemy((30*function.scaleX(64)), (160*function.scaleY(64))));
		...
		case 302: //Plains Challenge
			...
			platforms.add(new Platform(-17, -43, 127, 2, 1));
